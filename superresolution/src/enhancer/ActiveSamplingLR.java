...
//C:/Users/NISHIKESH DALKARI/Desktop/pratham/
...
public class ActiveSamplingLR {
    ...
    public double[] stats()
    {
        ...
        try {
            ...
            Logger.getLogger(ActiveSamplingLR.class.getName()).log(Level.SEVERE, null, ex);
        }
        return (range);
    }
    ...
    public static void main(String[] args) throws IOException{
        ...
        ActiveSamplingLR AS = new ActiveSamplingLR();
        AS.stats();
    }
}
